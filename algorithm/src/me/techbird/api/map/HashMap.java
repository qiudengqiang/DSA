package me.techbird.api.map;

import me.techbird.tool.printer.BinaryTreeInfo;
import me.techbird.tool.printer.BinaryTrees;
...
public class HashMap<K, V> implements Map<K, V> {
    ...
    private Node<K, V> successor(Node<K, V> node) {
        if (node == null) return null;
        //从右子树的左子树中寻找后继节点（right.left.left.left...）
